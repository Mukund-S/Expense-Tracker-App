  ...
  const handleDeleteClick = async (itemKey) => {
    ...
    if (data.success === true) {
      const updatedTransactions = transactions.filter(
        (transaction) => transaction._id !== itemKey
      );
                            ...
                            <Modal.Body>
                              <Form onSubmit={handleEditSubmit}>
                                ...
                                >
                                  ...
                                  >
                                    <option
                                      value={editingTransaction[0].transgroup}
                                    >
                                      {editingTransaction[0].transgroup}
                                    </option>
                                    {props.groups.map((transgroup) => (
                                      <option
                                        key={transgroup._id}
                                        value={transgroup._id}
                                      >
